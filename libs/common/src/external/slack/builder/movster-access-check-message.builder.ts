...
export interface IMovesterAccessCheckMessageBuilderParam {
    userId: number;
    nickName: string;
    accessTime: string;
}

export class MovesterAccessCheckMessageBuilder extends SlackBuilder {
    constructor(
        private param: IMovesterAccessCheckMessageBuilderParam) {
        super(
    ...
    buildBlock() {
        ...
        return [
            this.makeHeaderSection(`:movester: *뭅스터 방문 알림*`),
            this.makeDivider(),
